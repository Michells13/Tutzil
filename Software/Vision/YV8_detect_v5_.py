...
import cv2
import time
from utils5 import traclets, configure_model, run_yolo, initialize_yolo, process_frame,createTextFile, readTextFile, start_camera,start_server
...
config = {
    ...
    "device": None,  # Device for inference (e.g., cpu, cuda:0)
